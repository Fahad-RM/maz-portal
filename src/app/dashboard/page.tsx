        ...
        <div className="space-y-6 text-xs animate-fade-up">
          ...
          <div className="flex flex-col lg:flex-row gap-5 items-start">
            ...
            <div className="flex-1 w-full space-y-5">
              ...
              {/* Active Stream Header & Clear Chat */}
              {odooChatHistory.length > 0 && (
                <div className="flex items-center justify-between px-3 py-2 bg-purple-50/70 border border-purple-100/80 rounded-2xl">
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-purple-600 animate-pulse"></span>
                    <span className="text-[11px] font-bold text-purple-950 uppercase tracking-wider">
                      Conversation Stream ({odooChatHistory.length} {odooChatHistory.length === 1 ? "query" : "queries"})
                    </span>
                  </div>
                  <button
                    onClick={() => {
